...
export default class Aluno {
  ...
  setIdDisciplina(idDisciplina) {
    if (!Aluno.validarIdDisciplina(idDisciplina))
  ...
  setDisciplina(disciplina) {
    if (!Aluno.validarDisciplina(disciplina))
      throw new ModelError('Disciplina Inválida: ' + disciplina);
    this.disciplina = disciplina;
  }

  setCH(cargaHoraria) {
    if (!Aluno.validarCH(cargaHoraria))
  ...
  static assign(obj) {
    return new Aluno(obj.idDisciplina, obj.disciplina, obj.cargaHoraria);
  }
